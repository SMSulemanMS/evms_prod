...
def approve_visitor(visitor_id):
    ...
    if visitor.status != 'Pending':
        ...
        return redirect(url_for('main.event_visitors', event_id=visitor.event_id)  + f"#visitor-{visitor.id}")
...
def delete_visitor(visitor_id):
    ...
    return redirect(url_for('main.event_visitors', event_id=event_id)+ f"#visitor-{visitor.id}")
